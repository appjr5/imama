...
/// Purple gradient theme replicating the original iMama Android UI.
class AppTheme {
  ...
  // Same purple identity, just recomposed for a dark background. The
  // color theme itself (primaryPurple/secondaryPurple) is unchanged.
